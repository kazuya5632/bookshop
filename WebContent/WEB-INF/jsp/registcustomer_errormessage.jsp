<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0045)http://localhost:8080/bookshop/registcustomer -->
<html>
<head>
...
<body style="font-size: 12px;">
	<div align="center">
		...
		<form method="post"
			action="./registcustomer_errormessage_files/registcustomer_errormessage.html">
			<div style="color: red; font-weight: bold;">登録ユーザ名を入力してください</div>
