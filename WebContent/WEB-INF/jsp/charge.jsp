...
<body style="font-size: 12px;">
	...
	<div align="center">
		...
		<br> <br> <br> <br> お買い上げありがとうございました<br> <br>
		お買い上げ内容 <br> <br>
		...
		<table border="1" style="font-size: 12px;">
			<tbody>
				...
				<c:forEach var="cart" items="${requestScope.shoppingCart.cartItems}">
					<tr>
		...
		<br> <br> 合計金額 ￥${shoppingCart.totalAmount} <br> <br>
		<a href="http://localhost:8080/bookshop/searchBooksInit">戻る</a> <br> <br>
		<a href="http://localhost:8080/bookshop/searchBooksInit">検索ページ</a>
		&nbsp;&nbsp;&nbsp; <a href="http://localhost:8080/bookshop/viewcart">ショッピングカートの中を見る</a>
		<!-- &nbsp;&nbsp;&nbsp; <a href="./shoppingcart_files/shoppingcart.html">ショッピングカートの中を見る</a> -->
